        ...
        <form action="/berobat" method="post">
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="confirm_rujuk" id="1" value="1" {{ Session::get('confirm_rujuk') == '1' ?  'checked' : ''}} onChange="checkOption(this)">
                    <label class="form-check-label" for="1">Ya</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="confirm_rujuk" id="0" value="0" {{ Session::get('confirm_rujuk') == '0' ?  'checked' : ''}} onChange="checkOption(this)">
                    <label class="form-check-label" for="0">Tidak</label>
                </div>
            </div>
            <div class="mb-3">
                <label for="nama_obat_id" class="form-label">Nama Obat</label>
                <select class="form-select" name="nama_obat_id" id="nama_obat_id">
                    <option selected>-</option>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="nama_rs_id" id="nama_rs_id">
                    <option selected>-</option>
