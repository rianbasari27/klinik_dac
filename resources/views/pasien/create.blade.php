    ...
    <div class="mx-2 mt-3 pt-4 bg-light shadow rounded">
        <div class="row">
            <div class="col-sm-6">
                ...
                <p class="ps-3 text-muted">Tambah data pasien</p>
            </div>
        </div>
        <hr>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror" type="radio" name="jenis_kelamin" id="laki-laki" value="Laki-laki" {{ old('jenis_kelamin') == 'Laki-laki' ?  'checked' : ''}}>
